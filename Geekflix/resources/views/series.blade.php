                 ...
                 <div class="col-12 col-lg-10 offset-lg-1 align-self-center">
                   ...
                   @auth
                     @hasStartedSeries($series)
                         <a href="{{ route('series.display', $series->slug) }}" class="btn btn-lg btn-primary mr-16 btn-round">CONTINUE</a>                        
                     @else
                         <a href="{{ route('series.display', $series->slug) }}" class="btn btn-lg btn-primary mr-16 btn-round">START</a>                      
                     @endhasStartedSeries
                   @else
                         <a href="{{ route('login') }}" class="btn btn-lg btn-primary mr-16 btn-round">START</a>                    
                   @endauth
                 </div>
   ...
   <section class="section">
     <div class="container">
       <header class="section-header">
         <small><strong>SERIES DESCRIPTION</strong></small>
         <h2>What's this series about ?</h2>
         <hr>
       </header>
   ...
   <section class="section bg-gray">
       <div class="container">
         <header class="section-header">
           <h2>Videos</h2>
           <hr>
           <p class="lead">Sneak peek of the videos already available</p>
         </header>
       </div>
     </section>
@endsection
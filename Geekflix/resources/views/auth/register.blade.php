...
<html lang="en">
 <head>
   ...
   <!-- Favicons -->
   <link rel="apple-touch-icon" href="assets/img/robot.png">
   <link rel="icon" href="assets/img/robot.png">
 </head>

 <body class="mh-fullscreen bg-img center-vh p-20" style="background-image: url(assets/img/bg-stars.jpg);">
